...
/// Every valid type `T` of a [`Point<T,S,Z>`](crate::Point) implements the `PointType` trait.
...
/// multiplications. The only example of this is [G](crate::G).
...
pub trait YChoice: Normalized + NotBasePoint {
    ...
    fn bytes_into_point<S: Secrecy>(bytes: [u8; 32]) -> Option<Point<Self, S, NonZero>>;
